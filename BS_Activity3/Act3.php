...
<div class = "container-fluid">
     ...
     <ul class = "nav nav-pills">
        <li class = "active"><a href="#">Home</a></li>
            <li class = "dropdown">
                <a class = "dropdown-toggle" data-toggle = "dropdown" href="#">PHP</a>
...
<div class = "panel-group" id = "myaccordion">
        ...
        <div class = "panel panel-info">
            ...
            <div class = "collapse panel-collapse" id = "colap2">
                <div class = "panel-body"><img src="pics/goku.jpeg"></div>
            </div>
        </div>
    ...
    <div class = "panel-group">
        ...
        <div class = "collapse panel-collapse" id="efg">
            <ul>
                ...
                <li class = "list-group-item">BSA</li>
            </ul>
...
<div class = "container">
    ...
    <div id = "dtx" class = "collapse"><img src="pics/goku.jpeg"></div>
</div>
